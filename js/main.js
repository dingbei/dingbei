...
$('#main-nav > li').each(function () {
	...
	//console.log(url,$(this).children('a')[0].getAttribute('href'),$(this))
	if(url.toUpperCase().indexOf($(this).children('a')[0].getAttribute('href').trim().toUpperCase()) != -1){
...
var initialise = function initialise() {
  ...
  application.fadeColour = 'rgba(155,155,155,0.01)';
